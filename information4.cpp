...
0.5,0.5,0.25,0.25,      //10
0.2,0.6,0.2,0.25,       //11
0.25,0.5,0.5,0.25,      //12
0.25,0.5,0.25,0.25,     //13
0.2,0.2,0.6 };	    	//	
long double pro33[3][3][4] =  //下标000  001 002  003  004  
	                      //    010  011  012  013  014
{ 0.0,0.6,0.8,1.0,            //0.0是因为又选到了a， 选到b就是前面一个a的值，选到c就是前面a和b的和
0.0,0.25,0.5,1.0,
0.0,0.25,0.5,1.0,
0.0,0.5,0.75,1.0,
0.0,0.2,0.8,1.0,              //举例：abbc,选到c的时候，low值的改动，需要0.8=0.2+0.6
0.0,0.25,0.5,1.0,
0.0,0.5,0.75,1.0,
0.0,0.5,0.75,1.0,
0.0,0.2,0.4,1.0 };	

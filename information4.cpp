...
{ 0.6,0.2,0.2,0.25,     //00-0  00-1  00-2  00-3      
0.25,0.5,0.25,0.25,     //01-0  01-1  01-2  01-3
0.5,0.5,0.25,0.25,      //02
0.2,0.6,0.2,0.25,       //03
0.25,0.5,0.5,0.25,      //10
0.25,0.5,0.25,0.25,     //11
0.2,0.2,0.6 };	    	//12	
long double pro33[3][3][4] =  //举例：abbc,选到c的时候，low值的改动，需要0.8=0.2+0.6
	                      //0.0是因为又选到了a， 选到b就是前面一个a的值，选到c就是前面a和b的和
{ 0.0,0.6,0.8,1.0,0.0,        //下标000  001 002  003  004 
0.25,0.5,1.0,0.0,0.25,        //    010  011  012  013  014
0.5,1.0,0.0,0.5,0.75,         //    02
1.0,0.0,0.2,0.8,1.0,          //    03  
0.0,0.25,0.5,1.0,0.0,         //    04
0.5,0.75,1.0,0.0,0.5,         //    10
0.75,1.0,0.0,0.2,0.4,         //    11
1.0 };	                      //    12
